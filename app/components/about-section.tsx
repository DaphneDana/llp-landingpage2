  ...
  return (
    <section className="bg-[#F8F9FA] py-20 relative">
      <div className="max-w-6xl mx-auto px-8 relative">
        {" "}
        {/* Reduced from max-w-7xl and increased px from 4 to 8 */}
        {/* Sticky Sidebar Navigation */}
        <div className="sticky top-32 right-0 float-right w-72 bg-white shadow-lg p-6 z-30 hidden lg:block ml-6 mb-8">
          {" "}
          {/* Reduced width and padding, removed rounded corners */}
          <h3 className="text-xl font-bold text-[#058DD6] mb-6">会社概要</h3> {/* Reduced text size */}
        ...
        <div className="lg:pr-80">
          ...
          <div id="leadership" className="mb-16">
            ...
            <div className="mb-8">
              {" "}
              {/* Reduced margin */}
              <h2 className="text-3xl font-bold text-[#058DD6] mb-4">代表挨拶</h2> {/* Reduced text size */}
              <div className="w-16 h-1 bg-[#058DD6]"></div> {/* Reduced width */}
            </div>
            <div className="bg-white shadow-lg p-8">
              {" "}
              {/* Removed rounded corners, reduced padding */}
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="lg:w-80 flex-shrink-0">
                  ...
                  <div className="w-full h-64 bg-gray-200 overflow-hidden">
                    {" "}
                    {/* Removed rounded corners, reduced height */}
                    <img
          ...
          <div id="overview" className="mb-16">
            ...
            <div className="mb-8">
              {" "}
              {/* Reduced margin */}
              <h2 className="text-3xl font-bold text-[#058DD6] mb-4">会社概要</h2> {/* Reduced text size */}
              <div className="w-16 h-1 bg-[#058DD6]"></div> {/* Reduced width */}
            </div>
          ...
          <div id="philosophy" className="mb-16">
            ...
            <div className="mb-8">
              {" "}
              {/* Reduced margin */}
              <h2 className="text-3xl font-bold text-[#058DD6] mb-4">企業理念</h2> {/* Reduced text size */}
              <div className="w-16 h-1 bg-[#058DD6]"></div> {/* Reduced width */}
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {[
                ...
                <div
                  key={index}
                  className="bg-[#EFF6FF] border border-[#E0F2FE] p-6 border-l-4 border-l-[#058DD6]" /* Removed rounded corners, reduced padding */
                >
                  <philosophy.icon className="w-10 h-10 text-[#058DD6] mb-3" /> {/* Reduced icon size and margin */}
          ...
          <div id="history" className="mb-16">
            ...
            <div className="mb-8">
              {" "}
              {/* Reduced margin */}
              <h2 className="text-3xl font-bold text-[#058DD6] mb-4">沿革</h2> {/* Reduced text size */}
              <div className="w-16 h-1 bg-[#058DD6]"></div> {/* Reduced width */}
            </div>
            <div className="bg-white shadow-lg overflow-hidden">
              {" "}
          ...
          <div id="certifications" className="mb-16">
            ...
            <div className="mb-8">
              {" "}
              {/* Reduced margin */}
              <h2 className="text-3xl font-bold text-[#058DD6] mb-4">標識</h2> {/* Reduced text size */}
              <div className="w-16 h-1 bg-[#058DD6]"></div> {/* Reduced width */}
            </div>
            <div className="space-y-6">
              ...
              <div className="bg-white shadow-lg overflow-hidden">
                ...
                <div className="bg-[#058DD6] text-white p-3 text-center">
                  {" "}
                  {/* Reduced padding */}
                  <h3 className="text-base font-bold">政府セキュリティ認定事業者証</h3> {/* Reduced text size */}
                </div>
                <table className="w-full">
                  <tbody>
                    {[
              ...
              <div className="bg-white shadow-lg overflow-hidden">
                ...
                <div className="bg-[#058DD6] text-white p-3 text-center">
                  {" "}
                  {/* Reduced padding */}
                  <h3 className="text-base font-bold">ISO認証取得状況</h3> {/* Reduced text size */}
                </div>
                <table className="w-full">
                  <tbody>
                    {[
                ...
                <div className="bg-white p-6 shadow-lg">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-[#1E3A8A] text-sm">所在地</p> {/* Reduced text size */}
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-[#1E3A8A] text-sm">電話番号</p> {/* Reduced text size */}
                        <p className="text-[#374151] text-sm">TEL.03-1234-5678</p> {/* Reduced text size */}
                        <p className="text-[#374151] text-sm">FAX.03-1234-5679</p> {/* Reduced text size */}
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <Mail className="w-4 h-4 text-[#058DD6] mt-1 flex-shrink-0" />
                      <div>
                        <p className="font-semibold text-[#1E3A8A] text-sm">メールアドレス</p> {/* Reduced text size */}
                        <p className="text-[#374151] text-sm">info@aegisllp.co.jp</p> {/* Reduced text size */}
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <Clock className="w-4 h-4 text-[#058DD6] mt-1 flex-shrink-0" />
                      <div>
                        <p className="font-semibold text-[#1E3A8A] text-sm">営業時間</p> {/* Reduced text size */}
                        <p className="text-[#374151] text-sm">平日 8:30〜17:30</p> {/* Reduced text size */}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-1">
                <div className="bg-gray-200 h-64 flex items-center justify-center">
                  ...
                  <div className="text-center text-gray-500">
                    <MapPin className="w-10 h-10 mx-auto mb-2" /> {/* Reduced icon size */}
                    <p className="text-sm">Interactive Map</p> {/* Reduced text size */}
                    <p className="text-xs">Google Maps Integration</p> {/* Reduced text size */}
                  </div>
                </div>
              </div>
            </div>
